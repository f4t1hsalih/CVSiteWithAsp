  ...
  <body id="page-top">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-primary fixed-top" id="sideNav">
      <a class="navbar-brand js-scroll-trigger" href="#page-top">
        ...
        <span class="d-none d-lg-block">
          <img class="img-fluid img-profile rounded-circle mx-auto mb-2" src="/Folders/img/profile.jpg" alt="">
        </span>
      </a>
    ...
    <div class="container-fluid p-0">
      ...
      <section class="resume-section p-3 p-lg-5 d-flex d-column" id="about">
        <div class="my-auto">
          <h1 class="mb-0">Salih
            <span class="text-primary">Doğan</span>
          </h1>
          <div class="subheading mb-5">İstanbul - Türkiye · (555) 555-5555 ·
            <a href="mailto:name@email.com">f4t1hsalih@gmail.com</a>
          </div>
